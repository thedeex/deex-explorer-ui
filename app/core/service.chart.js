                ...
                $http.get(appConfig.urls.python_backend + "/daily_volume_dex_dates").then(function (response) {
                    $http.get(appConfig.urls.python_backend + "/daily_volume_dex_data").then(function (response2) {
                        ...
                        dex_volume_chart.options = {
                            animation: true,
                            title: {
                                text: 'Daily DEX Volume in DEEX for the last 30 days'
                            },
                            tooltip: {
                                trigger: 'axis'
                            },
                ...
                $http.get(appConfig.urls.python_backend + "/top_proxies").then(function(response) {
                    ...
                    proxies_chart.options = {
                        ...
                        series: [{
                            ...
                            data: [
                                {value: response.data[0].deex_weight, name: response.data[0].name},
                                {value: response.data[1].deex_weight, name: response.data[1].name},
                                {value: response.data[2].deex_weight, name: response.data[2].name},
                                {value: response.data[3].deex_weight, name: response.data[3].name},
                                {value: response.data[4].deex_weight, name: response.data[4].name},
                                {value: response.data[5].deex_weight, name: response.data[5].name},
                                {value: response.data[6].deex_weight, name: response.data[6].name}
                            ]
                        }]
                    };
